...
public class Stage1PalaceinCam : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        if (0 < p_Input.horizontal)
        {
            ...
            {
                targetPosition.Set(key * (target.transform.position.x + 4), target.transform.position.y + 6, this.transform.position.z);
        ...
        else if (p_Input.horizontal < 0)
        {
            ...
            if (target.gameObject != null)
            {
                targetPosition.Set((target.transform.position.x - 3), target.transform.position.y + 6, this.transform.position.z);
                this.transform.position = Vector3.Lerp(this.transform.position, targetPosition, moveSpeed * Time.deltaTime * 5.0f);
            }
        ...
        else
        {
            if (target.gameObject != null)
            {
                targetPosition.Set((target.transform.position.x), target.transform.position.y + 5, this.transform.position.z);
                this.transform.position = Vector3.Lerp(this.transform.position, targetPosition, moveSpeed * Time.deltaTime * 5.0f);
            }
